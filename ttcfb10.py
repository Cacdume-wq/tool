...
def Main():
    ...
    print(f"{thanh} {luc}Nhập {do}[{vang}4{do}]{luc} Để Chạy Nhiệm Vụ Cảm Xúc")
    print(f"{thanh} {luc}Nhập {do}[{vang}5{do}]{luc} Để Chạy Nhiệm Vụ Cảm Xúc Cmt")
    ...
    while True:
        ...
        for ck in listck:
            ...
            if '1' in cauhinh:
                print(f'{luc}Đang Cấu Hình ID: {vang}{_info[1].encode("utf-8", "replace").decode()} {vang}| {luc}Tên Facebook: {vang}{_info[2].encode("utf-8", "replace").decode()}')
            else:
                print(f"{red}════════════════════════════════════════════════════")
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}LIKE{do} | {trang}{uuid}{do} | {vang}+1100{do} | {luc}{str(format(int(xu),","))}')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvlikethuong == 1:
                    ...
                    if like1 == []:
                        ...
                        for x in like2:
                            ...
                            like = _Like(ck, uuid, "LIKE", _info[0], _info[1])
                            if like == False:
                                print(f"{cam}FAIL LIKE: {lam}{uuid}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loilike += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}LIKE{do} | {trang}{uid}{do} | {vang}+600{do} | {luc}{str(format(int(xu),","))}')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}{typee}{do} | {trang}{uid}{do} | {vang}+1100{do} | {luc}{str(format(int(xu),","))}')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}{typee}CMT{do} | {trang}{uid}{do} | {vang}+600{do} | {luc}{str(format(int(xu),","))}')
                                    loicxcmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}FOLLOW{do} | {trang}{uid}{do} | {vang}+700{do} | {luc}{str(format(int(xu),","))}')
                                    loifl = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}COMMENT{do} | {trang}{uid}{do} | {vang}+1400{do} | {luc}{str(format(int(xu),","))}')
                                    loicmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if share == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}SHARE{do} | {trang}{uid}{do} | {vang}+600{do} | {luc}{str(format(int(xu),","))}')
                                    loishare = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if likepage == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}LIKEPAGE{do} | {trang}{uid}{do} | {vang}+1300{do} | {luc}{str(format(int(xu),","))}')
                                    loilikepage = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
