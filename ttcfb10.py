...
def Main():
    ...
    while True:
        if os.path.exists('Cookie_FB.txt'):
            ...
            chon = Write.Input(f'Lựa Chọn Của Bạn: ',Colors.green_to_cyan,interval=0.0001)
            if chon == '1':
    ...
    print(f"{trang}════════════════════════════════════════════════════")
    Write.Print('''[1] - LIKEVIP\n[2] - LIKEGIARE\n[3] - REACTIONVIP\n[4] - REACTIONGIARE\n[5] - REACTIONCMT\n[6] - CMTCHEO\n[7] - SHARE\n[8] - LIKEPAGE\n[9] - FOLLOW\n🌟 Lưu Ý: Có Thể Chọn Nhiều Nhiệm Vụ (VD: 123...)\n''',Colors.yellow_to_green,interval=0.0001)
    print(f"{trang}════════════════════════════════════════════════════")
    nhiemvu = input (f'{thanh}{luc} Nhập Nhiệm Vụ Cần Chạy: {lam}')
    min = int(input(f'{thanh}{luc} Nhập Delay Min: {lam}'))
    max = int(input(f'{thanh}{luc} Nhập Delay Max: {lam}'))
    nvblock = int(input(f'{thanh}{luc} Sau Bao Nhiêu Nhiệm Vụ Thì Chống Block: {lam}'))
    delaybl = int(input(f'{thanh}{luc} Sau {lam}{nvblock} Nhiệm Vụ Thì Nghỉ Ngơi: {lam}'))
    doinick = int(input(f'{thanh}{luc} Sau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick: {lam}'))
    nhiemvuloi = int(input(f'{thanh}{luc} Lỗi Bao Nhiêu Nhiệm Vụ Thì Xóa Cookie: {lam}'))
    while True:
        if len(listck) == 0:
        ...
        for ck in listck:
            ...
            if '1' in cauhinh:
                print(f'{luc}UID : {vang}{_info[1].encode("utf-8", "replace").decode()} {red}| {luc}NAME : {vang}{_info[2].encode("utf-8", "replace").decode()}')
            else:
                print(f"{red}════════════════════════════════════════════════════")
            ...
            while True:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mLIKEVIP\033[1;31m|\033[1;35m+1100xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvlikethuong == 1:
                    listlike = getjob(cookie, 'likepostgiare')
                    like1 = listlike.text
                    like2 = listlike.json()
                    if like1 == []:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                nhan = requests.post('https://tuongtaccheo.com/kiemtien/likepostgiare/nhantien.php',headers=headers, data=data).json()
                                if 'mess' in nhan:
                                    headers = {
                                        "Host": "tuongtaccheo.com",
                                        "x-requested-with": "XMLHttpRequest",
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mLIKEGIARE\033[1;31m|\033[1;35m+600xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mCAMXUCVIPCHEO\033[1;31m|\033[1;35m+1100xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mCAMXUCCHEO\033[1;31m|\033[1;35m+600xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32m{typee}CMT\033[1;31m|\033[1;35m+600xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loicxcmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mFOLLOW\033[1;31m|\033[1;35m+700xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loifl = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvcmt == 1:
                    ...
                    if like1 == []:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                print(f"{red}FAIL CMT{trang} :{uid}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loicmt += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mCMTCHEO\033[1;31m|\033[1;35m+1400xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loicmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                        ...
                        for x in like2:
                            ...
                            if likepage == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'\033[1;31m|\033[1;31m{dem}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mLIKEPAGECHEO\033[1;31m|\033[1;35m+1300xu\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}')
                                    loilikepage = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
